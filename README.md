...
- [berlinru.slack.com](https://berlinru.slack.com), slack людей из Берлина и остальной Германии, более 2200 пользователей, чтобы получить инвайт заполните форму [здесь](https://berlinru.herokuapp.com/)
  ...
  - Исходя из вышеперечисленного, Вы НЕ анонимны в чате, если используете емейл, по которому Вас можно найти.
  ...
  - В чате практикуется и одобряется деанонимизация участников с "неправильным" мнением с последующим обнародованием полного имени, ссылок на LinkedIn/VK/FB + личных фото, места работы и тп.
