...
- [berlinru.slack.com](https://berlinru.slack.com), slack людей из Берлина и остальной Германии, более 2200 пользователей, чтобы получить инвайт заполните форму [здесь](https://berlinru.herokuapp.com/)
  - !!! Админу Slack чата виден Ваш email. Также, всем участникам чата виден Ваш уникальный id вида U********. Таким образом, даже при смене имени и username, Вас все равно могут находить по этому айди. Сменить его невозможно!
  - Исходя из вышеперечисленного, Вы НЕ анонимны в чате, если используете емейл, по которому Вам можно найти.
  - Админ чата может в любое время сохранить всю историю всех чатов, таким образом, даже если Вы удалите свое сообщение, кто-то сможет иметь к нему доступ. Читать [здесь](https://slack.com/help/articles/201658943-Export-your-workspace-data)
  - Админ шарит сохраненную историю с некоторыми участниками чата
  - используя искуственный интеллект, Ваши сообщения могут быть проанализированы с целью составления Вашего уникального "почерка" (определенная пунктуация, выбор слов и тп), что в дальнейшем может быть использовано для "вычисления" Вас, если Вы заведете новый аккаунт и продолжите писать в чате
  - В чате практикуется и одобряется деанонимизация участников с "неправильным" мнением с последующим обнародованием полного имени, ссылок на LinkedIn/VK/FB + личных фото, места работа и тп.
